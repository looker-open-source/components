...
&lt;/form&gt;</code></pre>
  ...
  <p class="m-b-1-xs">Use <code>.form-radio</code> immediately following a <code>label</code> to get Lens's default radio button style.</p>
...
&lt;/form&gt;</code></pre>
  ...
  <p class="m-b-1-xs">Use <code>.form-checkbox</code> immediately following a <code>label</code> to get Lens's default checkbox style.</p>
...
&lt;/form&gt;</code></pre>
  ...
  <p class="m-b-1-xs">Use <code>.form-upload</code> immediately following a <code>label</code> to get Lens's default file upload style.</p>
...
&lt;/form&gt;</code></pre>
  ...
  <p class="m-b-1-xs">Wrap each field in a <code>fieldset</code> and add the <code>.fieldset</code> and <code>.form-feedback-success</code> to apply Lens's default for feedback styling. Additionally, add a <code>span</code> with the class of <code>form-feedback</code> to inform the user what the feedback is.</p>
...
&lt;/form&gt;</code></pre>
  ...
  <p class="m-b-1-xs">Wrap each field in a <code>fieldset</code> and add the <code>.fieldset</code> and <code>.form-feedback-warning</code> to apply Lens's default for feedback styling. Additionally, add a <code>span</code> with the class of <code>form-feedback</code> to inform the user what the feedback is.</p>

  <form class="m-b-2-xs">
    <fieldset class="form-feedback-warning form-fieldset">
      <label class="form-label">Radio Label</label>
      <input type="radio" id="form-radio-3" class="form-radio" name="radio">
      <label for="form-radio-3" class="form-label">Radio Label 1</label>
      <input type="radio" id="form-radio-4" class="form-radio" name="radio">
      <label for="form-radio-4" class="form-label">Radio Label 2</label>
...
&lt;/form&gt;</code></pre>
  ...
  <p class="m-b-1-xs">Wrap each field in a <code>fieldset</code> and add the <code>.fieldset</code> and <code>.form-feedback-error</code> to apply Lens's default for feedback styling. Additionally, add a <code>span</code> with the class of <code>form-feedback</code> to inform the user what the feedback is.</p>
