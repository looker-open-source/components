...
<lens-main>
  ...
  <section id="markup">
    <p class="m-b-4-xs">Lens includes resources to
    ...
    <p class="m-b-2-xs">Lens contains a lot of utility classes that can be
    ...
    <p class="m-b-2-xs">BEM is a well-known method of naming components — block,
    ...
    <p class="m-b-2-xs">A block represents the main component. If you were
    ...
    <p class="m-b-2-xs">An element is part of the main component and its class
    ...
    <p class="m-b-2-xs">A modifier is a component or element variation that
    ...
    <p class="m-b-4-xs">If the sandwich has swiss cheese, a variation can be
    ...
    <p class="m-b-4-xs">The one place we diverge from BEM is within our utility
    ...
    <p class="m-b-2-xs">Most of our variables are built using Sass maps, which
    ...
    <p class="m-b-2-xs">As mentioned above, many variables are accessible via
