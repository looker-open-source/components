...
- Revert: Introduction of peerDependencies in beta.21 (introduced lint / test breakage to consumers)
...
- Changed several key dependencies to peerDependencies to allow consumers to have minor version differences without duplicate packages
