...
You can extend the theme provided by Looker Components by passing colors, fonts, and more into the `themeCustomizations` prop.
...
The following colors are available for customization, the first three being the most likely to need to be customized:
...
These colors are less likely to need to be customized:
