...
Looker Compnents ships a small collection of density "helpers". The `Density` component takes a `density` value.
...
Also included are a set of helpers for each specific density size: `Density1`, `Density0`, `DensityN1`, `DensityN2`, `DensityN3` (where `N` denotes "negative")
