...
<Span variant="secondary">Secondary Text</Span>
<Span variant="subdued">Subdued Text</Span>
<Span variant="critical">Critical Text</Span>
<Span variant="positive">Positive Text</Span>
```
