...
<MessageBar noActions intent="warn" mb="u4">
  <Paragraph>
...
<Flex justifyContent="space-between">
  <Flex
    ...
    bg="key"
  >
    <FlexItem width="70%" m="u3" p="xsmall" bg="ui1">
      Aligned w/
    </FlexItem>
    <FlexItem width="30%" m="u3" p="xsmall" bg="ui1">
      Space
    </FlexItem>
    <FlexItem width="50%" m="u3" p="xsmall" bg="ui1">
      Betwen
    </FlexItem>
  </Flex>
  <Flex
    ...
    bg="inform"
  >
    <FlexItem width="70%" m="u3" p="xsmall" bg="ui2">
      Aligned w/
    </FlexItem>
    <FlexItem width="30%" m="u3" p="xsmall" bg="ui2">
      Flex
    </FlexItem>
    <FlexItem width="50%" m="u3" p="xsmall" bg="ui2">
      End
    </FlexItem>
  </Flex>
  <Flex
    ...
    bg="positive"
  >
    <FlexItem width="70%" m="u3" p="xsmall" bg="ui3">
      Aligned w/
    </FlexItem>
    <FlexItem width="30%" m="u3" p="xsmall" bg="ui3">
      Flex
    </FlexItem>
    <FlexItem width="50%" m="u3" p="xsmall" bg="ui3">
      Center
    </FlexItem>
  </Flex>
</Flex>
