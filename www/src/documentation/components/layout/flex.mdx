...
import { Code, Paragraph, MessageBar } from '@looker/components'
import {
...
<MessageBar noActions intent="warn" mb="medium">
  <Paragraph>
    <Code>Flex</Code> has been deprecated. Use a more specific layout helper
    such as
    <a href="./space">
      <Code>Space</Code> or <Code>SpaceVertical</Code>
    </a> or <a href="./grid">
      <Code>Grid</Code>
    </a>
  </Paragraph>
  <Paragraph>
    <strong>NOTE:</strong> <Code>&lt;Box2 display="flex" /&gt;</Code> is
    functionally identical to today's <Code>Flex</Code>.
  </Paragraph>
</MessageBar>
