...
>
  <FlexItem mr="medium" pt="xsmall">
    <Icon icon={<Menu />} color="inverseOn" size={24} />
  </FlexItem>
  <FlexItem>
    <Icon icon={<LookerLogo />} color="inverseOn" size={60} />
  </FlexItem>
  <FlexItem flex="1">
    <Flex justifyContent="center">
      <Box px="small">
        <Text fontSize="xsmall" color="inverted">
          Browse <Icon icon={<ExpandMore />} />
        </Text>
      </Box>
      <Box px="small">
        <Text fontSize="xsmall" color="inverted">
          Explore <Icon icon={<ExpandMore />} />
        </Text>
      </Box>
      <Box px="small">
        <Text fontSize="xsmall" color="inverted">
          Develop <Icon icon={<ExpandMore />} />
        </Text>
      </Box>
      <Box px="small">
        <Text fontSize="xsmall" color="inverted">
          Admin <Icon icon={<ExpandMore />} />
        </Text>
      </Box>
    </Flex>
  </FlexItem>
  <FlexItem>
    <Flex>
      <FlexItem mr="small">
        <Icon icon={<Search />} color="inverseOn" size={24} />
      </FlexItem>
      <FlexItem mr="small">
        <Icon icon={<Chat />} color="inverseOn" size={24} />
      </FlexItem>
      <FlexItem>
        <Icon icon={<Group />} color="inverseOn" size={24} />
      </FlexItem>
    </Flex>
  </FlexItem>
</Flex>
