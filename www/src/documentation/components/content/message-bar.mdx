...
- `primaryAction`: boolean, ReactElement, or string
- `onPrimaryClick`: () => void
- `secondaryAction`: boolean, ReactElement, or string
- `onSecondaryClick`: () => void

### Non-clearable MessageBar

If you don't want the MessageBar to be clearable, you can set `primaryAction` to `false`.

```jsx
<MessageBar primaryAction={false}>I can't be closed</MessageBar>
```
