...
<MessageBar my="large" canDismiss={false}>
  Note: TimeFormat must be imported from its specific location rather than the
  package root.
</MessageBar>

Import path: `@looker/components/lib/TimeFormat`
