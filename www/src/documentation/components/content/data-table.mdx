...
The `<DataTableCell>` component is equivalent to a data cell in your DataTable. `<DataTableCell>` elements should always be children of an `<DataTableItem>` element (i.e. each row should contain some number of column elements).
