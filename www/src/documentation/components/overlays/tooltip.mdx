...
By default, the tooltip will show and hide after a brief delay. To make it show and hide immediately, use the `disableDelay` prop.

```jsx
<Tooltip content="This tooltip shows immediately" disableDelay>
