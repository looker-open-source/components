...
Icon buttons have the `toggleColor` prop which can be used to specify a theme-derived background color to the Icon. The `toggle` prop has to be explictly set to either `true` or `false`.
