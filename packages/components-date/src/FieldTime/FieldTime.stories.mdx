import { FieldTime } from '@looker/components-date'

<Meta component={FieldTime} title="Docs/Components/Fields/FieldTime" />

# FieldTime

<ImportMessage packageName="components-date">FieldTime</ImportMessage>
