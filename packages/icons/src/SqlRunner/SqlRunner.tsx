...
export const SqlRunner: StyledIcon = React.forwardRef<
  SVGSVGElement,
  StyledIconProps
>((props, ref) => {
...
export const SqlRunnerDimensions = {height: 24, width: 24}
