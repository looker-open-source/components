    ...
    <Box>
      <GridWrapper>
        ...
        <Flex flexDirection="column" alignItems="center">
          ...
          <Paragraph fontSize="small">
            Search or browse through the component listing on this site. You can
            use the interactive prompts to compose whole components right in
            Lens.
          </Paragraph>
        </Flex>
        <Flex flexDirection="column" alignItems="center">
          ...
          <Paragraph fontSize="small">
            ...
            contribution guidelines and best practices, then open a Pull Request
            on the Lens repository.
          </Paragraph>
        </Flex>
      </GridWrapper>
    </Box>
