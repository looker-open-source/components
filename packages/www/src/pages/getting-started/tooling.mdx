...
![Configure Typescript](../../assets/typescript_config.jpg)
...
1. Create a new test configuration by selecting "Edit Configurations...":
   ...
   ![New Test Configuration](../../assets/intellij_test_configuration.jpg)

1. Click the `+` icon in the top left and choose "Jest":

   ![Add Jest Configuration](../../assets/intellij_test_configuration_add.jpg)
...
1. Click the play button (or debug button) to run all the tests:
   ...
   ![Run all tests](../../assets/intellij_run_all_tests.jpg)

1. Your output should look something like:

   ![Run output](../../assets/intellij_run_all_tests_output.jpg)

##### Run an individual test

![Running a single test](../../assets/intellij_run_individual_test.gif)
