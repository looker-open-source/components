...
<img
  src={require('../../assets/img/typescript_config.jpg')}
  alt="Configure Typescript"
/>
...
<img
  src={require('../../assets/img/tslint_config.jpg')}
  alt="Configure TSLint"
/>
...
1. Create a new test configuration by selecting "Edit Configurations...":
   ...
   <img
     src={require('../../assets/img/intellij_test_configuration.jpg')}
     alt="New Test Configuration"
   />

1) Click the `+` icon in the top left and choose "Jest":

   <img
     src={require('../../assets/img/intellij_test_configuration_add.jpg')}
     alt="Add Jest Configuration"
   />
...
1) Click the play button (or debug button) to run all the tests:
   ...
   <img
     src={require('../../assets/img/intellij_run_all_tests.jpg')}
     alt="Run all tests"
   />
...
1) Your output should look something like:
   ...
   <img
     src={require('../../assets/img/intellij_run_all_tests_output.jpg')}
     alt="Run output"
   />
...
<img
  src={require('../../assets/img/intellij_run_individual_test.gif')}
  alt="Running a single test"
/>
