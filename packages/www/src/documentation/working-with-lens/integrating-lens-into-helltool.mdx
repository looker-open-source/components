...
route: /working-with-lens/integrating-lens-into-helltool
menu: Working with Lens
---

# Integrating Lens into Helltool
...
<img
  src={require('../../assets/img/admin_connection_form.jpg')}
  alt="Admin connection form"
/>
...
<img
  src={require('../../assets/img/admin_connection_form_highlighted.jpg')}
  alt="Admin connection form highlighted"
/>
