...
- <Code>
    onNowClick
  </Code>: the user clicked the month label to return to the current month
- <Code>
    onMonthChange
  </Code>: the user navigated to a new month (could be through any mouse or keyboard interaction)
