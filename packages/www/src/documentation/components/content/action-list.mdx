...
The `actionsButtonLabel` prop can be used to set a visually hidden label on the actions button. This is especially useful for getting the actions button DOM element when testing your `<ActionList>`.
