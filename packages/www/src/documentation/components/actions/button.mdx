...
⚠️ The variant property is deprecated, and will be removed for the 1.0 release ⚠️
...
`variant="outline"` instead use the component `ButtonOutline`
`variant="transparent"` instead use the component `ButtonTransparent`
