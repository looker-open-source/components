---
name: Fields
route: components/forms/fields/select
---

import { Playground } from 'docz'
import { Button, FieldSelect } from '@looker/components'
import { ComponentDetail } from '../../../../components'
import { FieldSelectOption, FieldSelectOptionValidation } from './demos'
