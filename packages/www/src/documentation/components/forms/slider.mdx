...
`Slider` comes in four sizes, which can be specified in the `size` prop:

```jsx
<Slider size="xsmall" value={2} />
...
```jsx
<Slider size="xsmall" value={2} branded />
...
;() => {
  ...
  myTheme.colors.semanticColors.primary.main = '#008930'
