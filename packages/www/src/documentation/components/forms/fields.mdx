...
<FieldCheckbox name="know" label="I know my name (see above)" />
<Divider mb="large" />
<FieldText name="name" label="Name" alignLabel="left" />
<FieldCheckbox alignLabel="right" label="I am awesome!" required />
<FieldCheckbox name="requiredField" alignLabel="right" label="I love cheese!" />
<Divider mb="large" />
<FieldCheckbox name="left-label" label="Label on Left" alignLabel="left" labelFontWeight="normal" />
```
