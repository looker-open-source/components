...
>
  <FlexItem mr="medium" pt="xsmall">
    <Icon name="Hamburger" color="inverseText" size={24} />
  </FlexItem>
  <FlexItem>
    <Icon name="LookerLogo" color="inverseText" size={60} />
  </FlexItem>
  <FlexItem flex="1">
  ...
  <FlexItem>
    <Flex>
      <FlexItem mr="small">
        <Icon name="Search" color="inverseText" size={24} />
      </FlexItem>
      <FlexItem mr="small">
        <Icon name="Chat" color="inverseText" size={24} />
      </FlexItem>
      <FlexItem>
        <Icon name="Group" color="inverseText" size={24} />
      </FlexItem>
    </Flex>
  </FlexItem>
</Flex>
...
<Flex bg="ui1" mb="large">
  ...
  <FlexItem>
    <Box m="small" p="large" bg="ui5" color="inverseText">
      3
    </Box>
  </FlexItem>
  <FlexItem>
