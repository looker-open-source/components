...
const resources = {
  Table: {
    'Shift + Click to sort additional columns': 'Shift + לחיצה למיון עמודות נוספות',
    'Sort ascending': 'מיון בסדר עולה',
    'Sort descending': 'מיון בסדר יורד',
    Totals: 'סכומים'
  }
};
export const heIL = mergeLocaleObjects([componentsLocale, visualizationsadaptersLocale], 'he-IL', resources);
