...
var getFilterMap = function getFilterMap(filterMap, payload) {
  ...
  if (filter.title) {
    var _filter$title2 = filter.title,
      _filterToRemove = filterMap[_filter$title2],
      rest = (0, _objectWithoutProperties2["default"])(filterMap, [_filter$title2].map(_toPropertyKey));
    return rest;
  }
  return filterMap;
};
