...
var resources = {
  ...
  NoMatchingFields: {
    ...
    'Try Something Else': 'Versuchen Sie es mit einem anderen Suchbegriff oder beginnen Sie von vorne und erweitern Sie einen beliebigen Explore, um die verfügbaren Felder zu durchsuchen.'
  },
  NumberFilter: {
...
var deDE = (0, _i18n.mergeLocaleObjects)([_components.deDE, _filterExpressions.deDE], 'de-DE', resources, _de["default"]);
exports.deDE = deDE;
