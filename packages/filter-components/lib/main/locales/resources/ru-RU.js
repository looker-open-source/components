...
var resources = {
  ...
  NoMatchingFields: {
    ...
    'Try Something Else': 'Попробуйте использовать другое условие поиска или вернитесь и разверните любой объект Explore, чтобы просмотреть доступные поля.'
  },
  NumberFilter: {
...
var ruRU = (0, _i18n.mergeLocaleObjects)([_components.ruRU, _filterExpressions.ruRU], 'ru-RU', resources, _ru["default"]);
exports.ruRU = ruRU;
