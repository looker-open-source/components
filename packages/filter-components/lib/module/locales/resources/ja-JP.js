...
const resources = {
  ...
  NoMatchingFields: {
    ...
    'Try Something Else': '別の検索語句を試すか、最初からもう一度 Explore を展開し、利用可能なフィールドを確認してください。'
  },
  NumberFilter: {
    'any value': '任意の値'
  },
...
export const jaJP = mergeLocaleObjects([componentsLocale, filterexpressionsLocale], 'ja-JP', resources, dateLocale);
