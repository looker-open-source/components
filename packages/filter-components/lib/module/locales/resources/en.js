...
import { en as filterexpressionsLocale } from '@looker/filter-expressions';
...
const resources = {
  ...
  NoMatchingFields: {
    ...
    'Try Something Else': 'Try another search term or start over and expand any explore to browse available fields.'
  },
  NumberFilter: {
    'any value': 'any value'
  },
...
export const en = mergeLocaleObjects([componentsLocale, filterexpressionsLocale], 'en', resources, dateLocale);
