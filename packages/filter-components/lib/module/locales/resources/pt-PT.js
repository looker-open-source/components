...
import { ptPT as filterexpressionsLocale } from '@looker/filter-expressions';
...
const resources = {
  ...
  NoMatchingFields: {
    'No Matching Fields': 'Sem campos correspondentes',
    'Try Something Else': 'Tente outro termo de pesquisa ou recomece e expanda qualquer opção explorar para navegar nos campos disponíveis.'
  },
  NumberFilter: {
...
export const ptPT = mergeLocaleObjects([componentsLocale, filterexpressionsLocale], 'pt-PT', resources, dateLocale);
