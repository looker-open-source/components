...
import { nbNO as filterexpressionsLocale } from '@looker/filter-expressions';
...
const resources = {
  ...
  NoMatchingFields: {
    'No Matching Fields': 'Ingen samsvarende felt',
    'Try Something Else': 'Prøv et annet søkeord eller start på nytt og utvid utforskingen for å bla gjennom tilgjengelige felt.'
  },
  NumberFilter: {
...
export const nbNO = mergeLocaleObjects([componentsLocale, filterexpressionsLocale], 'nb-NO', resources, dateLocale);
