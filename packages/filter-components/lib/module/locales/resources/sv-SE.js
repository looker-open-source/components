...
const resources = {
  ...
  NoMatchingFields: {
    'No Matching Fields': 'Inga matchande fält',
    'Try Something Else': 'Prova en annan sökterm eller börja om och expandera eventuella Utforska-vyer för att bläddra bland tillgängliga fält.'
  },
  NumberFilter: {
...
export const svSE = mergeLocaleObjects([componentsLocale, filterexpressionsLocale], 'sv-SE', resources, dateLocale);
