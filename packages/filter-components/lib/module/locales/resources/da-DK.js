...
const resources = {
  ...
  NoMatchingFields: {
    'No Matching Fields': 'Ingen matchende felter',
    'Try Something Else': 'Prøv et andet søgeord, eller udvid en udforsk-funktion for at gennemse tilgængelige felter.'
  },
  NumberFilter: {
...
export const daDK = mergeLocaleObjects([componentsLocale, filterexpressionsLocale], 'da-DK', resources, dateLocale);
