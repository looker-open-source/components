...
import {plPL as filterexpressionsLocale} from '@looker/filter-expressions'
  ...
  "NoMatchingFields": {
    ...
    "Try Something Else": "Spróbuj wyszukać inne hasło lub zacznij od nowa i rozwiń dowolny wgląd, aby przejrzeć dostępne pola."
  },
  "NumberFilter": {
  ...
  "use_filters_errors": {
    ...
    "No value is set for your user attribute": "Nie ustawiono wartości atrybutu użytkownika",
