...
import {ptBR as filterexpressionsLocale} from '@looker/filter-expressions'
  ...
  "NoMatchingFields": {
    ...
    "Try Something Else": "Tente usar outro termo de pesquisa ou recomece e abra qualquer Explore para procurar campos disponíveis."
  },
  "NumberFilter": {
  ...
  "use_filters_errors": {
    ...
    "No value is set for your user attribute": "Nenhum valor foi definido para o atributo do usuário",
