...
const resources = {
  Query: {
    'No children passed to Query component':
      'Aucun enfant transmis au composant de requête',
    'Query component received both dashboard and query props':
      'Le composant de requête a reçu des propositions de tableau de bord et de requête',
  },
  QueryError: {
    Error: 'Erreur',
  },
  Visualization: {
    "Measures of type 'date' are currently not supported":
      'Les mesures de type "date" ne sont pas compatibles actuellement',
