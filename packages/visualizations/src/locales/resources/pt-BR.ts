...
const resources = {
  Query: {
    'No children passed to Query component':
      'Nenhum filho foi transmitido ao componente de consulta',
    'Query component received both dashboard and query props':
      'O componente de consulta recebeu as propostas de consultas e dashboard',
  },
  QueryError: {
    Error: 'Erro',
  },
  Visualization: {
    "Measures of type 'date' are currently not supported":
      'No momento, as medições do tipo "date" não são suportadas',
