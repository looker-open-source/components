...
const resources = {
  Query: {
    'No children passed to Query component':
      'Nessun figlio trasmesso al componente della query',
    'Query component received both dashboard and query props':
      'Il componente della query ha ricevuto proposte di dashboard e query',
  },
  QueryError: {
    Error: 'Errore',
  },
  Visualization: {
    "Measures of type 'date' are currently not supported":
      'Al momento, le misure di tipo "data" non sono supportate',
