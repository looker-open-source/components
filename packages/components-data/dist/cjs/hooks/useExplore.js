...
var useExplore = function useExplore(id) {
    ...
    var _ref = _asyncToGenerator(_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            if (!(id && model && view && (0, _isEmpty["default"])(explore))) {
              _context.next = 5;
              break;
            }
            request = {
            ...
            _context.next = 4;
            return sdk.lookml_model_explore(request);
          case 4:
  ...
  var _useSWR = (0, _swr["default"])("useExplore-".concat(model, "-").concat(view), fetcher, {
