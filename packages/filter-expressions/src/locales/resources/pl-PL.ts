  ...
  "describe_date": {
    ...
    "is from dateTimeStart until dateTimeEnd": "przypada na okres od {{dateTimeStart}} do {{dateTimeEnd}}",
    ...
    "is intervalStart intervalType for intervalEnd": "to {{intervalStart}} {{intervalType}} dla {{intervalEnd}}",
    ...
    "this": "to",
    "this startInterval to endInterval": "od: {{startInterval}} do: {{endInterval}}",
