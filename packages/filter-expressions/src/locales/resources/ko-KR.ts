  ...
  "describe_date": {
    ...
    "is before": "다음 날짜 이전:",
    "is day": "{{day}}",
    "is from dateTimeStart until dateTimeEnd": "{{dateTimeStart}}~{{dateTimeEnd}}",
    "is in month year": "{{year}}년 {{month}}",
    "is in the last": "지난 {{describeInterval}}",
    "is in the year year": "{{year}}년",
    "is interval ago": "{{interval}} 전",
    "is intervalStart intervalType for intervalEnd": "{{intervalEnd}} 동안 {{intervalStart}} {{intervalType}}",
    "is not null": "null 아님",
  ...
  "get_unit_label": {
    "complete day": "하루 전체",
    "complete days": "일 전체",
    "complete fiscal quarter": "회계 분기 전체",
    "complete fiscal quarters": "회계 분기 전체",
    "complete fiscal year": "회계 연도 전체",
    "complete fiscal years": "회계 연도 전체",
    "complete hour": "1시간 전체",
    "complete hours": "시간 전체",
    "complete minute": "1분 전체",
    "complete minutes": "분 전체",
    "complete month": "1개월 전체",
    "complete months": "개월 전체",
    "complete quarter": "1분기 전체",
    "complete quarters": "분기 전체",
    "complete second": "1초 전체",
