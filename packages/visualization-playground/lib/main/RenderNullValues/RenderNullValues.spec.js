...
describe('RenderNullValues', function () {
  ...
  it('hidden when render_null_values is unsupported', function () {
    var _renderWithTheme = (0, _componentsTestUtils.renderWithTheme)(_react["default"].createElement(_RenderNullValues.RenderNullValues, {
        config: {
          type: 'unsupported'
        },
  ...
  it('toggles render_null_values', function () {
    (0, _componentsTestUtils.renderWithTheme)(_react["default"].createElement(_RenderNullValues.RenderNullValues, {
