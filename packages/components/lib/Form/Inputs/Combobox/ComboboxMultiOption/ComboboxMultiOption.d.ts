...
export declare const ComboboxMultiOption: import("styled-components").StyledComponent<React.ForwardRefExoticComponent<ComboboxOptionProps & React.RefAttributes<HTMLLIElement>>, import("styled-components").DefaultTheme, {
    ...
    fontSize: import("styled-system").ResponsiveValue<import("packages/design-tokens/lib").FontSizes, Required<import("styled-system").Theme<import("styled-system").TLengthStyledSystem>>>;
    lineHeight: import("styled-system").ResponsiveValue<import("packages/design-tokens/lib").FontSizes, Required<import("styled-system").Theme<import("styled-system").TLengthStyledSystem>>>;
