...
}, "value" | "aria-describedby" | "aria-labelledby" | "disabled" | "readOnly" | "defaultValue" | "id" | "onChange" | "locale" | "border" | "borderBottom" | "borderColor" | "borderLeft" | "borderRight" | "borderTop" | "borderX" | "borderY" | keyof import("styled-system").BorderRadiusProps<Required<import("styled-system").Theme<import("styled-system").TLengthStyledSystem>>, string | number | symbol> | "validationType" | "onValidationFail" | keyof SpaceProps<Required<import("styled-system").Theme<import("styled-system").TLengthStyledSystem>>, string | number | symbol> | "dateStringFormat"> & React.RefAttributes<HTMLInputElement>>, import("styled-components").DefaultTheme, {}, never>;
