...
export const useTooltip = ({
  ...
  return useMemo(() => {
    const popper = renderDOM && content && !disabled ? React.createElement(DialogContext.Provider, {
      value: {
        busy,
        closeModal: handleClose,
        id: guaranteedId
      }
    }, React.createElement(Portal, null, React.createElement(TooltipSurface, {
  ...
  }, [busy, className, canOpen, content, disabled, guaranteedId, handleClose, handleMouseOut, initializeOpen, invert, _maxWidth, placement, popperInstanceRef, ref, renderDOM, style, textAlign, triggerElement, width, ariaDescribedById]);
};
