...
const resources = {
  ...
  BulkActions: {
    AllPageCountDisplayedSelected: 'Todos os {{pageCount}} itens apresentados selecionados',
    ...
    SelectedCountOfTotalDisplayed: '{{selectedItemCount}} de {{pageCount}} itens apresentados selecionados'
  },
  CalendarNav: {
  ...
  FieldTimeSelect: {
    'Please use format HHMM': 'Utilize o formato HH:MM'
  },
  GetIntentLabel: {
    Error: 'Erro',
    Inform: 'Informar',
...
export const ptPT = mergeLocaleObjects([], 'pt-PT', resources, dateLocale);
