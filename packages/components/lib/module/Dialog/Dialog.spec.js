...
import { Controlled, ControlledLegacy, ControlledNoChildren, CloseIconButton } from './stories/index.stories';
describe('Dialog', () => {
  ...
  test('Controlled', async () => {
    ...
    const doneButton = screen.getByText('Done Reading');
    fireEvent.click(doneButton);
    await waitForElementToBeRemoved(() => screen.queryByText(/Lorem Ipsum is simply/));
  });
