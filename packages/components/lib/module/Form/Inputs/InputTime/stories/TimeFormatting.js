...
export default function TimeFormatting(props) {
  ...
  return React.createElement(Grid, null, React.createElement(SpaceVertical, {
    ...
    as: "h3"
  }, "12-hour"), React.createElement(Space, null, React.createElement(InputTime, _extends({
    format: "12h",
    value: value,
    onChange: setValue
    ...
    as: "h3"
  }, "24-hour"), React.createElement(Space, null, React.createElement(InputTime, _extends({
    format: "24h",
    value: value,
    onChange: setValue
  }, restProps)))));
