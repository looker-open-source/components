...
function Controlled() {
  ...
  return _react["default"].createElement(_.Space, null, _react["default"].createElement(_.Menu, {
    ...
    content: _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement(_.MenuItem, {
      icon: _react["default"].createElement(MaterialIcons.Email, null)
    }, "Email"), _react["default"].createElement(_.MenuItem, {
      icon: _react["default"].createElement(MaterialIcons.TableChart, null)
    }, "Spreadsheet"))
  }, _react["default"].createElement(_.Button, null, "Export")), _react["default"].createElement(_.Text, null, isOpen ? 'Menu Open' : 'Menu Closed'));
}
