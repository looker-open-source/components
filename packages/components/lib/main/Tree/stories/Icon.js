...
function Icon() {
  return _react["default"].createElement(_.TreeCollection, null, _react["default"].createElement(_.Tree, {
    defaultOpen: true,
    icon: _react["default"].createElement(MaterialIcons.Alarm, null),
    label: _react["default"].createElement("strong", null, _react["default"].createElement(_Layout.Space, {
      between: true
    }, "\"Alarm\" icon has margin-right, but \"Download\" icon does not", _react["default"].createElement(MaterialIcons.Download, {
      size: 20
    })))
