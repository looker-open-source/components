...
var _Controlled = _interopRequireDefault(require("./stories/Controlled"));
var _ = require(".");
...
describe('Tree', function () {
  ...
  test('Handles controlled open state via isOpen and toggleOpen props', function () {
    (0, _componentsTestUtils.renderWithTheme)(_react["default"].createElement(_Controlled["default"], null));
    var treeLabel = _react2.screen.getByText('Controlled Tree');
    _react2.screen.getByText('Cost');
    _react2.fireEvent.click(treeLabel);
    expect(_react2.screen.queryByText('Cost')).not.toBeInTheDocument();
    _react2.fireEvent.click(treeLabel);
    _react2.screen.getByText('Cost');
