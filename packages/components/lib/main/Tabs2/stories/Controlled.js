...
function Controlled() {
  ...
  return _react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement(_.Paragraph, null, "The current selected tab is: ", currentTabId), _react["default"].createElement(_.Button, {
    onClick: function onClick() {
      return setTabId('cats');
    }
  }, "Switch to Cats"), _react["default"].createElement(_.Button, {
    onClick: function onClick() {
