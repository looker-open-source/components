...
describe('List', function () {
  describe('windowing', function () {
    ...
    test('windows a long list', function () {
      (0, _componentsTestUtils.renderWithTheme)(_react["default"].createElement(_index.LongList, null));
  ...
  describe('keyboard navigation', function () {
    test('up and down arrow keys traverse from item to item', function () {
      (0, _componentsTestUtils.renderWithTheme)(_react["default"].createElement(_react["default"].Fragment, null, _react["default"].createElement("button", null, "Start Button"), _react["default"].createElement(_index.KeyboardNavigation, null)));
