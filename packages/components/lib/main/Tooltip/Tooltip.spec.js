...
var popperJSCore = _interopRequireWildcard(require("@popperjs/core"));
...
describe('Tooltip', function () {
  ...
  test('isOpen', function () {
    var createPopperSpy = jest.spyOn(popperJSCore, 'createPopper');
    (0, _componentsTestUtils.renderWithTheme)(_react["default"].createElement(_Tooltip.Tooltip, {
      content: "Hello world",
      isOpen: true
    }, _react["default"].createElement(_Button.Button, null, "Test")));
  ...
  test('can open returns true', function () {
    (0, _componentsTestUtils.renderWithTheme)(_react["default"].createElement(_Tooltip.Tooltip, {
    ...
    _react2.fireEvent.mouseOver(button);
    runTimers();
    expect(_react2.screen.getByText('Hello world')).toBeVisible();
    _react2.fireEvent.mouseOut(button);
    runTimers();
  });
  test('can open returns false', function () {
    (0, _componentsTestUtils.renderWithTheme)(_react["default"].createElement(_Tooltip.Tooltip, {
      canOpen: function canOpen() {
        return false;
      },
