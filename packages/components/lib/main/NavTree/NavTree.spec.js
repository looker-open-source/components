...
describe('NavTree', function () {
  test('ripple effect', function () {
    (0, _componentsTestUtils.renderWithTheme)(_react["default"].createElement(_NavList.NavList, null, _react["default"].createElement(_NavTree.NavTree, {
      defaultOpen: true,
      label: "Cheeses"
    }, _react["default"].createElement(_NavTreeItem.NavTreeItem, {
      parentIcon: true
  ...
  test('Triggers onClick on label click', function () {
    ...
    (0, _componentsTestUtils.renderWithTheme)(_react["default"].createElement(_NavTree.NavTree, {
      onClick: labelClick,
      label: "Parent"
  ...
  describe('href provided', function () {
    test('Changes accordion open state on indicator click', function () {
      (0, _componentsTestUtils.renderWithTheme)(_react["default"].createElement(_index.Link, null));
