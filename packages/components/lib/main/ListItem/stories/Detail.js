...
function Detail() {
  return _react["default"].createElement(_2.List, null, _react["default"].createElement(_.ListItem, {
  ...
  }, "ListItem (Standard)"), _react["default"].createElement(_.ListItem, {
    icon: _react["default"].createElement(MaterialIcons.Tag, null),
    detail: _react["default"].createElement(_2.IconButton, {
      icon: _react["default"].createElement(MaterialIcons.PivotTableChart, null),
      label: _react["default"].createElement(MaterialIcons.PivotTableChart, null),
      onClick: function onClick() {
        return alert("You've pivoted!");
      }
    }),
    itemRole: "none"
  }, "ListItem (Standard)"), _react["default"].createElement(_.ListItem, {
    icon: _react["default"].createElement(MaterialIcons.Tag, null),
    detail: {
      content: _react["default"].createElement(_2.IconButton, {
        icon: _react["default"].createElement(MaterialIcons.PivotTableChart, null),
        label: _react["default"].createElement(MaterialIcons.PivotTableChart, null),
        onClick: function onClick() {
          return alert("You've pivoted!");
