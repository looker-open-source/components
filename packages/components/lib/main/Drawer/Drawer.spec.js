...
describe('Drawer', function () {
  ...
  test('useDrawer hook', (0, _asyncToGenerator2["default"])(regeneratorRuntime.mark(function _callee2() {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          (0, _componentsTestUtils.renderWithTheme)(_react["default"].createElement(_index.UseDrawer, null));
  ...
  test('drawer form', (0, _asyncToGenerator2["default"])(regeneratorRuntime.mark(function _callee3() {
