...
var _Nested = _interopRequireDefault(require("./stories/Nested"));
var _AnimationCallbacks = _interopRequireDefault(require("./stories/AnimationCallbacks"));
var _ = require("./");
...
describe('Panel', function () {
  ...
  test('hidden content under panel is not reachable via keyboard nav', function () {
    (0, _componentsTestUtils.renderWithTheme)(_react2["default"].createElement(_Nested["default"], null));
  ...
  test('onAfterOpen, onAfterClose', function () {
    jest.useFakeTimers();
    (0, _componentsTestUtils.renderWithTheme)(_react2["default"].createElement(_AnimationCallbacks["default"], null));
