...
var _composeStories = (0, _testingReact.composeStories)(stories),
  RichDetailDescription = _composeStories.RichDetailDescription;
describe('FieldToggleSwitch', function () {
  ...
  test('tabStops', function () {
    (0, _componentsTestUtils.renderWithTheme)(_react["default"].createElement(RichDetailDescription, null));
