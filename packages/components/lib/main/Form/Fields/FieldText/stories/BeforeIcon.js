...
function BeforeIcon(props) {
  var _props$name = props.name,
    ...
    iconBefore = _props$iconBefore === void 0 ? _react["default"].createElement(MaterialIcons.Settings, null) : _props$iconBefore,
