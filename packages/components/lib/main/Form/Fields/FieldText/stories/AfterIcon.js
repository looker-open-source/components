...
function AfterIcon(props) {
  var _props$name = props.name,
    ...
    _props$iconAfter = props.iconAfter,
    iconAfter = _props$iconAfter === void 0 ? _react["default"].createElement(MaterialIcons.Settings, null) : _props$iconAfter,
