...
exports["default"] = ControlledFloatingLabel;
...
function ControlledFloatingLabel() {
  var _useState = (0, _react.useState)(new Date('04/07/1776')),
  ...
  }, "Today"), _react["default"].createElement(_.FieldDate, {
    externalLabel: false,
    label: "Controlled",
    value: today,
    onChange: setToday
