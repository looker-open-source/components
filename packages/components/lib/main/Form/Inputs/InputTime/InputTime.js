...
var parseValue = function parseValue(format) {
  ...
  if (value.length) {
    var _value$split$map3 = value.split(':').map(_utils.parseBase10Int),
      _value$split$map4 = (0, _slicedToArray2["default"])(_value$split$map3, 2),
      hr24 = _value$split$map4[0],
      minute = _value$split$map4[1];
...
var InputTimeInternal = (0, _react.forwardRef)(function (_ref2, ref) {
  ...
  var handleHourKeyDown = function handleHourKeyDown(e) {
    ...
    if (isNumericKey(e)) {
      var _value = (0, _utils.parseBase10Int)(
      inputState.charCount === 1 ? "".concat(hour).concat(e.key) : e.key);
      if (_value < 24) {
  ...
  (0, _react.useEffect)(function () {
    ...
    if ((0, _utils.isValidTime)(valueProp)) {
      var _parseValue3 = parseValue(format, valueProp),
        _parseValue4 = (0, _slicedToArray2["default"])(_parseValue3, 3),
        newHour = _parseValue4[0],
        newMinute = _parseValue4[1],
        newPeriod = _parseValue4[2];
