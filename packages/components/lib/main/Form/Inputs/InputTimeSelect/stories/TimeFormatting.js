...
function TimeFormatting(props) {
  var _format = props.format,
    ...
    valueProp = _props$value === void 0 ? '14:00' : _props$value,
  ...
  return _react["default"].createElement(_2.Grid, null, _react["default"].createElement(_2.SpaceVertical, {
    ...
    as: "h3"
  }, "12-hour"), _react["default"].createElement(_2.Space, null, _react["default"].createElement(_.InputTimeSelect, (0, _extends2["default"])({
    format: "12h",
    value: value,
    onChange: setValue
    ...
    as: "h3"
  }, "24-hour"), _react["default"].createElement(_2.Space, null, _react["default"].createElement(_.InputTimeSelect, (0, _extends2["default"])({
    format: "24h",
    value: value,
    onChange: setValue
  }, restProps)))));
