...
var ComboboxInputInternal = (0, _react.forwardRef)(function (props, forwardedRef) {
  ...
  var _selectOnClick = rest.selectOnClick,
    restForInputText = (0, _objectWithoutProperties2["default"])(rest, _excluded2);
  return _react["default"].createElement(_InputText.InputText, (0, _extends2["default"])({}, restForInputText, inputEvents, {
    disabled: disabled,
