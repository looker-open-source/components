...
var ComboboxOptionWrapper = (0, _styledComponents["default"])((0, _react.forwardRef)(function (props, forwardedRef) {
  ...
  }, _react["default"].createElement("li", (0, _extends2["default"])({}, (0, _designTokens.omitStyledProps)(rest), {
...
function ComboboxOptionTextInternal(_ref5) {
  ...
  if (!highlightText || !inputValue || inputValue === '' ||
  inputValue === (0, _getComboboxText.getComboboxText)(contextOption)) {
    return _react["default"].createElement("span", props, text);
  }
  return _react["default"].createElement("span", props, _react["default"].createElement(_ReplaceText.ReplaceText, {
    match: inputValue
  }, text));
}
