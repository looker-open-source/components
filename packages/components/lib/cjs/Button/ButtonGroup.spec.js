...
describe('ButtonGroup', function () {
  test('controlled', function () {
    function TestComponent() {
      ...
      return _react2["default"].createElement(_ButtonGroup.ButtonGroup, {
        value: value,
        onChange: setValue
  ...
  test('JSX children', function () {
    (0, _componentsTestUtils.renderWithTheme)(_react2["default"].createElement(_ButtonGroup.ButtonGroup, null, _react2["default"].createElement(_ButtonItem.ButtonItem, null, _react2["default"].createElement("strong", null, "BOLD"), " thing")));
