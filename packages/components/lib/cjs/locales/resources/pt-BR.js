...
var resources = {
  ...
  BulkActions: {
    AllPageCountDisplayedSelected: 'Todos os {{pageCount}} itens exibidos selecionados',
    ...
    SelectedCountOfTotalDisplayed: '{{selectedItemCount}} de {{pageCount}} itens exibidos selecionados'
  },
  CalendarNav: {
  ...
  FieldTimeSelect: {
    'Please enter a valid time': 'Insira um horário válido.'
  },
  GetIntentLabel: {
    Error: 'Erro',
    Inform: 'Informar',
