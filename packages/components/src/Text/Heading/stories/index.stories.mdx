...
import storyLevel from './Level?raw';
import storyFontSize from './FontSize?raw';
import storyFontWeight from './FontWeight?raw';
import storyTextTransform from './TextTransform?raw';
