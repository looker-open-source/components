...
import storyAccessibility from './Accessibility?raw';
import storyArtwork from './Artwork?raw';
import storyBasic from './Basic?raw';
import storyColor from './Color?raw';
import storyInsideComponents from './InsideComponents?raw';
import storyPairedWithText from './PairedWithText?raw';
