...
import storyIndicatorIcons from './IndicatorIcons?raw';
import storyLeft from './Left?raw';
...
<MessageBar noActions intent="inform">
  Accordion has been deprecated and replaced with `Accordion2` please update any
  existing instances to use the new improved version. Removal of `Accordion` is
  planned for @looker/components 3.0.
</MessageBar>
