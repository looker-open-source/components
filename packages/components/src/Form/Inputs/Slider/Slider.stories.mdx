...
<Meta component={Slider} title="Docs/Components/Inputs/Slider" />

# Slider

`Slider` is used for selecting a single value. If you need to specify a range of values, use the [`RangeSlider` component](/components/forms/range-slider) instead.
