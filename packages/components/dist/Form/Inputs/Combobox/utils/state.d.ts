 ...
 */
export declare const getStateChart: (shouldRenderListInline?: boolean | undefined) => StateChart;
...
export declare function useReducerMachine<TData = ComboboxData, TPayload = ComboboxActionPayload>(reducerFn: Reducer<TData, ComboboxAction & TPayload>, initialData: TData, defaultPayload: TPayload, shouldRenderListInline?: boolean): [ComboboxState, TData, ComboboxTransition<TPayload>];
