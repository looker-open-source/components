...
export const usePopoverToggle = ({
  ...
  allowTriggerClick: _allowTriggerClick = false
  ...
  }, [_cancelClickOutside, canClose, isOpen, setOpen, triggerElement, portalElement, triggerToggle, mouseDownTarget, _allowTriggerClick]);
