...
export function useInputEvents({
  ...
  function handleFocus(e) {
    ...
    if (openOnFocus && lastActionType !== ComboboxActionType.SELECT_WITH_CLICK && lastActionType !== ComboboxActionType.NAVIGATE && lastActionType !== ComboboxActionType.INTERACT) {
