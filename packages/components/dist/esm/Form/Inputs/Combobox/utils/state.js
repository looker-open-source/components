...
export const getStateChart = shouldRenderListInline => {
  const restState = shouldRenderListInline ? ComboboxState.SUGGESTING : ComboboxState.IDLE;
  return {
    initial: restState,
    states: {
      [ComboboxState.IDLE]: {
...
export function useReducerMachine(reducerFn, initialData, defaultPayload, shouldRenderListInline) {
