...
export declare const usePopoverToggle: ({ isOpen: controlledIsOpen, setOpen: controlledSetOpen, canClose, triggerToggle, cancelClickOutside, allowTriggerClick, }: UsePopoverToggleProps, portalElement: HTMLElement | null, triggerElement: HTMLElement | null) => [boolean, (value: boolean) => void];
