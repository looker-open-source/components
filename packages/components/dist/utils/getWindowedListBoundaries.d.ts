...
export declare type WindowResult = {
    start: number;
    end: number;
    before: ReactNode;
    after: ReactNode;
};
export declare function getWindowedListBoundaries({ buffer, height, scrollPosition, enabled, itemCount, itemHeight, spacerTag, }: GetWindowedListBoundaryProps): WindowResult;
