 ...
 */
export declare const listItemBackgroundColor: ({ color, colorOnHover, disabled, hovered: propsHovered, ripple, selected, theme: { colors }, }: ListItemBackgroundColorProps & {
    theme: Theme;
