...
var TreeLayout = (0, _react.forwardRef)(function (_ref, ref) {
  ...
  var content = _react["default"].createElement(_TreeItemContent.TreeItemContent, _extends({
    "aria-selected": selected,
    depth: depth,
    href: href,
    itemRole: itemRole
  ...
  return _react["default"].createElement(_utils.HoverDisclosureContext.Provider, {
    ...
    ref: ref
  }), content, outside), accordionIsOpen && _react["default"].createElement(TreeAccordionContent, _extends({
    border: border,
    density: density,
    depth: depth
  }, contentDomProps)))));
...
var dividersCSS = (0, _styledComponents.css)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  ", " {\n    margin-top: 1px;\n  }\n\n  & & {\n    margin-top: 1px;\n  }\n"])), _TreeItem.TreeItem);
