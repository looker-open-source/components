...
exports["default"] = ScrollSelectedAreas;
...
function ScrollSelectedAreas(props) {
  var hasAside = props.hasAside,
    rest = _objectWithoutProperties(props, _excluded);
  return _react["default"].createElement(_.Page, {
    fixed: true
  }, _react["default"].createElement(_.Layout, _extends({
    hasAside: hasAside
  ...
  }, _react["default"].createElement(_2.ConstitutionShort, null)), _react["default"].createElement(_.Layout, _extends({
    hasAside: hasAside
  }, rest), _react["default"].createElement(_.Section, {
    main: true,
    scrollWithin: true,
    p: "u10",
    style: {
