...
function AutoResize(props) {
  ...
  return _react["default"].createElement(_.Space, null, _react["default"].createElement(_2.FieldText, _extends({
    autoResize: autoResize,
    name: name,
    label: label,
    placeholder: placeholder
  }, restProps)), _react["default"].createElement(_2.FieldText, _extends({
    autoResize: autoResize,
    name: name,
    label: label,
    placeholder: placeholder,
