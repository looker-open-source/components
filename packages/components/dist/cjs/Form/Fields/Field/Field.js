...
exports.fieldPropKeys = exports.Field = void 0;
exports.omitFieldProps = omitFieldProps;
exports.pickFieldProps = void 0;
...
var _excluded = ["className", "description", "detail", "externalLabel", "id", "inline", "label", "hideLabel", "validationMessage", "width"];
...
var fieldPropKeys = ['className', 'description', 'detail', 'externalLabel', 'id', 'inline', 'label', 'hideLabel', 'validationMessage', 'width'];
...
function omitFieldProps(props) {
  var _className = props.className,
    _description = props.description,
    _detail = props.detail,
    _externalLabel = props.externalLabel,
    _id = props.id,
    _inline = props.inline,
    _label = props.label,
    _hideLabel = props.hideLabel,
    _validationMessage = props.validationMessage,
    _width = props.width,
...
var fieldLabelCSS = function fieldLabelCSS(inline) {
  return inline ? (0, _styledComponents.css)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n        height: ", ";\n        justify-self: end;\n        line-height: ", ";\n        padding-right: ", ";\n        text-align: right;\n      "])), _height.inputHeight, _height.inputHeight, function (_ref9) {
...
var inlineTemplateAreas = (0, _styledComponents.css)(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  grid-template-areas: 'label input detail' '. messages messages';\n"])));
var templateAreas = (0, _styledComponents.css)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  grid-template-areas: 'label detail' 'input input' 'messages messages';\n"])));
