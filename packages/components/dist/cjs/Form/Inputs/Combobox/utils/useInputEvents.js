...
function useInputEvents(_ref, context) {
  ...
  var _useContext = (0, _react.useContext)(context),
    ...
    shouldRenderListInline = _useContext.shouldRenderListInline,
  ...
  function handleFocus(e) {
    ...
    if (openOnFocus && lastActionType !== _state.ComboboxActionType.SELECT_WITH_CLICK && lastActionType !== _state.ComboboxActionType.NAVIGATE && lastActionType !== _state.ComboboxActionType.INTERACT) {
  ...
  }, [disabled, openOnClick, persistSelectionPropRef, shouldRenderListInline, state, selectText, transition]);
