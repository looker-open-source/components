...
/***/ (function(module, exports) {
	...
	m.directive("subnav", function() {
	  return {
	    ...
	    link: function(scope, $el, attrs, ctrl) {
	      return $(document).ready(function() {
	        var i, section_id, section_title, sections, subnav;
	        ...
	        if (sections.length > 0) {
	          ...
	          return $(subnav).on('click', '.guide-subnav-anchor', function() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	brandColors = __webpack_require__(21);

	uiColors = __webpack_require__(22);

	grayColors = __webpack_require__(23);
